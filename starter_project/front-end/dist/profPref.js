...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/profPref.js");
/******/ })
/************************************************************************/
/******/ ({
...
var urlPost = "http://" + hostName + "/api/constraints?token=" + token;

var logoutButton = ".mdl-navigation__link#logout";
...
function cSwap() {
  if (this.className == "noColor") this.className = "redColor";else if (this.className == "redColor") this.className = "noColor";
};
...
function getText() {
  if ($.trim($("textarea").val()) != "") motive = $("textarea").val();
};
function getDate() {
  ...
  for (var i = 0, row; row = table.rows[i]; i++) {
    for (var j = 0, col; col = row.cells[j]; j++) {
      if (col.className == "redColor") {
        if (j == 0) luni.push(col.innerHTML);else if (j == 1) marti.push(col.innerHTML);else if (j == 2) miercuri.push(col.innerHTML);else if (j == 3) joi.push(col.innerHTML);else if (j == 4) vineri.push(col.innerHTML);else if (j == 5) sambata.push(col.innerHTML);else if (j == 6) duminica.push(col.innerHTML);
      }
    }
  }timp.push(luni);
  timp.push(marti);
...
function getRoomsShow() {
  ...
  $.get("" + url).done(function (result) {
    for (var i = 0; i < result.rooms.length; i++) {
      pos = Math.ceil((i + 1) / 3);
      if (i % 3 == 0) $('#sali tbody').append('<tr id="tr' + pos + '"></tr>');
