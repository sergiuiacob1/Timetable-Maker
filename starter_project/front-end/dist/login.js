...
$(document).ready(function () {
	...
	var urlLogin = 'http://' + hostName + '/authenticate';
	var token = undefined;
	var errorMsg = false;
	...
	function apiLoginPost(credentials, callback) {
		...
		$.post(urlLogin, credentials).done(function (data) {
	...
	function handleLoginClick() {
		...
		apiLoginPost({ mail: username, password: password }, function (response, isAdmin) {
