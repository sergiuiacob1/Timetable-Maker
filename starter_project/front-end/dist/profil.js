...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/profil.js");
/******/ })
/************************************************************************/
/******/ ({
...
$(document).ready(function () {
	...
	__webpack_require__(/*! ../less/profil.less */ "./src/less/profil.less");
	...
	var changePassButton = ".mdl-button#change-pass";
	...
	function apiChangeUserPasswordPost(data, callback) {
		...
		var urlPostChangePassword = 'http://' + hostName + '/api/users/changepassword?token=' + token;
		console.log(data);

		$(".loader-bck").show();

		$.post(urlPostChangePassword, data).done(function (data) {
	...
	$(changePassButton).on("click", function () {
		var oldPass = $(".content-input #old-pass");
		var newPass = $(".content-input #new-pass");
		var confirmNewPass = $(".content-input #confirm-new-pass");

		var cond3 = verifyInput(confirmNewPass, $(confirmNewPass).val().length === 0 || $(confirmNewPass).val() !== $(newPass).val() ? /(?!)/ : /[\s\S]*/, "confirm-new-pass-req",
		...
		var cond2 = verifyInput(newPass, $(newPass).val().length === 0 || $(newPass).val() === $(oldPass).val() ? /(?!)/ : /[\s\S]*/, "new-pass-req",
		...
		var cond1 = verifyInput(oldPass, $(oldPass).val().length === 0 ? /(?!)/ : /[\s\S]*/, "old-pass-req", "Introduceti vechea parola");
