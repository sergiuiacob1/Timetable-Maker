...
$(document).ready(function () {
	...
	function renderSubjects(array) {
		...
		array.map(function (subj, index) {
			...
			$(".add-user .container .content-dropdown .demo-list-control.mdl-list.dropdown").append("<li class=\"mdl-list__item\" key=" + subj.id + ">\n                        <span class=\"mdl-list__item-primary-content\">\n                        " + subj.name + "\n                        </span>\n                     </li>");
		});
	...
	$(".add-user .container").on("click", function (event) {
		if (!event.target.matches(".add-user .demo-list-control.mdl-list.dropdown") && $(".add-user .demo-list-control.mdl-list.dropdown").has(event.target).length === 0 && !event.target.matches("#subjects")) {
