...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/orarulTau.js");
/******/ })
/************************************************************************/
/******/ ({
  ...
  */
  ...
  function start() {
    ...
    postThisShit(json, function (response) {
      alert(response);
      if (response === true) alert("Optiune adaugata!");else alert("Optiunea nu s-a adaugat. Va rugam reincercati.");
    });
