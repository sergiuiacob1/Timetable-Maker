...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/orarulTau.js");
/******/ })
/************************************************************************/
/******/ ({
...
$(document).ready(function () {
  ...
  var urlPost = 'http://' + hostName + '/api/linked_constraints?token=' + token;
  var urlDelete = 'http://' + hostName + '/api/delete_constraints?token=' + token;
  var urlDeleteLinked = 'http://' + hostName + '/api/delete_linked_constraints?token=' + token;

  __webpack_require__(/*! ./../less/profPref.less */ "./src/less/profPref.less");
  ...
  function getsubfromcons(id) {
    for (var i = 0; i < allconstraints.constraints.length; i++) {
      if (allconstraints.constraints[i].id == id) return subName(allconstraints.constraints[i].subjectId);
    }
  };
